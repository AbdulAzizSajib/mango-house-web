        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {hasItems && (
            <button
              ...
              className="flex justify-between items-center gap-1 px-2 py-3 sm:px-2 sm:py-1 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 active:scale-[0.97] hover:scale-[1.02] transition-all shadow-sm"
            >
